...
let convert_u_i32 x =
  F32.of_float
          (if x >= Int32.zero then Int32.to_float x else
           Int32.to_float (Int32.logor (Int32.shift_right_logical x 1) (Int32.logand x 1l)) *. 2.0)
...
let reinterpret_i32 (i:I32.t) = F32.of_bits i
