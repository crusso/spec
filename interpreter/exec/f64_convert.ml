 ...
 *)
let convert_u_i32 x =
  F64.of_float (Int64.to_float (Int64.logand (Int64.of_int32 x) 0x00000000ffffffffL))
...
let convert_u_i64 x =
  F64.of_float
        (if x >= Int64.zero then Int64.to_float x else
           Int64.to_float (Int64.logor (Int64.shift_right_logical x 1) (Int64.logand x 1L)) *. 2.0)

let reinterpret_i64 (i:I64.t) = F64.of_bits i
