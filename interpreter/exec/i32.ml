...
(*F#
  ...
  module Rep = struct
    ...
    let one : t = 1
    let minus_one : t = -1
    let max_int : t = System.Int32.MaxValue
    let min_int : t = System.Int32.MinValue
    ...
    let shift_left(i:t)(j:t) = i <<< j //TBR
    let shift_right(i:t)(j:t) = i >>> j //TBR
    let shift_right_logical(i:t)(j:t) = (int32) ((uint32) i >>> j) //TBT
